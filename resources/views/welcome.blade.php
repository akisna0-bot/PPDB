        ...
        <div class="container">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <img src="{{ asset('images/logo-new.png.png') }}" alt="SMK Bakti Nusantara 666" class="logo" style="margin-right: 1rem;">
                    <div>
                ...
                <div class="flex space-x-4">
                    @auth
                        <a href="{{ route('dashboard') }}" class="btn btn-yellow">
                            Dashboard
                        </a>
                    @else
    ...
    <section id="home" class="hero">
        <div class="container">
            ...
            <div style="margin-top: 2rem;">
                <a href="{{ route('register') }}" class="btn-green" style="margin-right: 1rem;">🚀 Daftar Sekarang</a>
            </div>
            @else
            <div style="margin-top: 2rem;">
                <a href="{{ route('dashboard') }}" class="btn-green">Dashboard Saya</a>
            </div>
            @endguest
        </div>
    </section>
