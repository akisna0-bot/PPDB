    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Selamat datang, <span class="font-semibold text-green-600"><?php echo e(auth()->user()->name ?? 'Verifikator'); ?></span></p>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 mb-6 border border-gray-200">
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('verifikator.daftar-pendaftar')); ?>" class="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm font-medium">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                    </svg>
                    Daftar Pendaftar
                </a>
                <a href="<?php echo e(route('verifikator.laporan')); ?>" class="flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition text-sm font-medium">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold"><?php echo e($stats['pending'] ?? 0); ?></p>
            ...
            <div class="bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold"><?php echo e($stats['verified'] ?? 0); ?></p>
            ...
            <div class="bg-gradient-to-r from-red-500 to-pink-500 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold"><?php echo e($stats['rejected'] ?? 0); ?></p>
            ...
            <div class="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold"><?php echo e($myVerifications ?? 0); ?></p>
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $recentActivities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                        <div class="flex items-center">
                            <div class="w-3 h-3 <?php echo e(in_array($activity->status, ['VERIFIED', 'PAYMENT_PENDING', 'PAYMENT_VERIFIED']) ? 'bg-green-500' : 'bg-red-500'); ?> rounded-full mr-3"></div>
                            <div>
                                <span class="text-sm font-medium text-gray-900"><?php echo e($activity->user->name ?? 'N/A'); ?></span>
                                <span class="text-xs text-gray-500 ml-2">(<?php echo e($activity->no_pendaftaran); ?>)</span>
                                <div class="text-xs text-gray-500"><?php echo e($activity->major->name ?? 'N/A'); ?></div>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-xs px-3 py-1 rounded-full font-medium
                                <?php if(in_array($activity->status, ['VERIFIED', 'PAYMENT_PENDING', 'PAYMENT_VERIFIED'])): ?> bg-green-100 text-green-800
                                <?php else: ?> bg-red-100 text-red-800 <?php endif; ?>">
                                <?php if($activity->status == 'VERIFIED' || $activity->status == 'PAYMENT_PENDING'): ?>
                                    ✅ Diverifikasi
                                <?php elseif($activity->status == 'PAYMENT_VERIFIED'): ?>
                                    💰 Sudah Bayar
                                <?php else: ?>
                                    ❌ Ditolak
                                <?php endif; ?>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                <?php echo e($activity->verified_at ? $activity->verified_at->format('d M Y H:i') : ($activity->tgl_verifikasi_adm ? $activity->tgl_verifikasi_adm->format('d M H:i') : 'N/A')); ?>

                            </p>
                            <?php if($activity->catatan_verifikasi): ?>
                                <p class="text-xs text-gray-400 mt-1 italic">"<?php echo e(Str::limit($activity->catatan_verifikasi, 30)); ?>"</p>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-8">
                        ...
                        <a href="<?php echo e(route('verifikator.daftar-pendaftar')); ?>" class="text-blue-600 hover:text-blue-800 text-sm mt-2 inline-block">
...
new Chart(verificationCtx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Diverifikasi',
            data: <?php echo json_encode($verificationTrend ?? [0,0,0,0,0,0,0]); ?>,
            ...
            label: 'Ditolak',
            data: <?php echo json_encode($rejectionTrend ?? [0,0,0,0,0,0,0]); ?>,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb\resources\views/verifikator/dashboard.blade.php ENDPATH**/ ?>